            ...
            <form action="acao.php" method="post">  <!-- esse formulário envia os dados para o arquivo acao.php -->
                <div class='row'>
                    ...
                    <div class='col'>
                        ...
                        <input type="text" class='form-control' name='Cidade' id='Cidade' placeholder="Informe sua cidade..."  value=<?php if(isset($usuario)) echo $usuario['cidade'] ?> >
                    </div>
                    <div class='col'>
                        <label for="name">Hobbies:</label>
                        <input type="text" class='form-control' name='nome' id='hobbies' placeholder="Informe seu hobbie favorito..."  value=<?php if(isset($usuario)) echo $usuario['hobbie'] ?> >
                    </div>
                    <div class='col'>
